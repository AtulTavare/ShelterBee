    ...
    try {
      ...
      await runTransaction(db, async (transaction) => {
        ...
        transaction.set(doc(txnRef), {
          ...
          type: "credit",
          amount: ownerCredit,
          description: `Booking ${bookingDisplayId || bookingId.substring(0, 8).toUpperCase()} - ${propertyTitle}`,
          bookingId,
          bookingDisplayId: bookingDisplayId || null,
          propertyTitle,
          bookingAmount,
        ...
        transaction.set(doc(txnRef), {
          ...
          type: "credit",
          amount: adminCredit,
          description: `Platform commission: ${bookingDisplayId || bookingId.substring(0, 8).toUpperCase()} - ${propertyTitle}`,
          bookingId,
          bookingDisplayId: bookingDisplayId || null,
          propertyTitle,
          bookingAmount,
    ...
    try {
      ...
      await runTransaction(db, async (transaction) => {
        ...
        transaction.set(doc(txnRef), {
          ...
          type: "debit",
          amount: ownerDebit,
          description: `Booking ${bookingDisplayId || bookingId.substring(0, 8).toUpperCase()} rejected - ${propertyTitle}`,
          bookingId,
          bookingDisplayId: bookingDisplayId || null,
          propertyTitle,
          bookingAmount,
        ...
        transaction.set(doc(txnRef), {
          ...
          description: `Commission reversed: ${bookingDisplayId || bookingId.substring(0, 8).toUpperCase()} - ${propertyTitle}`,
          bookingId,
          bookingDisplayId: bookingDisplayId || null,
          propertyTitle,
          walletProcessed: true,
        ...
        transaction.set(doc(txnRef), {
          ...
          description: `Payment partner charge: ${bookingDisplayId || bookingId.substring(0, 8).toUpperCase()} - ${propertyTitle}`,
          bookingId,
          bookingDisplayId: bookingDisplayId || null,
          propertyTitle,
          walletProcessed: true,
        ...
        transaction.set(doc(txnRef), {
          ...
          description: `Refund ${bookingDisplayId || bookingId.substring(0, 8).toUpperCase()} - ${propertyTitle}`,
          bookingId,
          bookingDisplayId: bookingDisplayId || null,
          propertyTitle,
          bookingAmount,
    ...
    try {
      ...
      await runTransaction(db, async (transaction) => {
        ...
        transaction.set(doc(txnRef), {
          ...
          description: `Cancellation debit: ${booking.bookingDisplayId || booking.id.substring(0, 8).toUpperCase()} - ${booking.propertyTitle}`,
          bookingId: booking.id,
          bookingDisplayId: booking.bookingDisplayId || null,
        ...
        if (refundPercent > 0) {
          ...
          transaction.set(doc(txnRef), {
            ...
            type: "credit",
            amount: refundAmount,
            description: `Refund ${refundPercent}%: ${booking.bookingDisplayId || booking.id.substring(0, 8).toUpperCase()} - ${booking.propertyTitle}`,
            bookingId: booking.id,
            bookingDisplayId: booking.bookingDisplayId || null,
            propertyTitle: booking.propertyTitle,
            bookingAmount: bookingAmount,
        ...
        if (adminGets > 0) {
          ...
          transaction.set(doc(txnRef), {
            ...
            type: "credit",
            amount: adminGets,
            description: `Cancellation charge: ${booking.bookingDisplayId || booking.id.substring(0, 8).toUpperCase()} - ${booking.propertyTitle}`,
            bookingId: booking.id,
            bookingDisplayId: booking.bookingDisplayId || null,
            propertyTitle: booking.propertyTitle,
            walletProcessed: true,
